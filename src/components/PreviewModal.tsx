        ...
        <div className="flex-1 overflow-y-auto bg-white text-slate-900 p-6 md:p-8">
           <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                 <div className="aspect-square bg-gray-100 border border-gray-300 rounded-lg overflow-hidden flex items-center justify-center">
                    {allImages.length > 0 ? (
                 ...
                 <div className="flex gap-2 overflow-x-auto pb-2">
                    {allImages.map((img, idx) => (
                        <div key={idx} className={`w-16 h-16 border rounded cursor-pointer overflow-hidden shrink-0 ${idx === 0 ? 'border-blue-500 border-2' : 'border-gray-300'}`}>
