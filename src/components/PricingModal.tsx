...
const PricingModal: React.FC<PricingModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleUpgrade = async (tier: 'PLUS' | 'PRO') => {
    ...
    const success = await startStripeCheckout(user.id, user.email || '', tier);
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in duration-300 overflow-y-auto">
      {/* Modal Container */}
      <div className="relative w-full max-w-5xl bg-slate-900 border border-slate-700 rounded-3xl shadow-2xl scale-100 animate-in zoom-in-95 duration-300 my-8 overflow-hidden">
        ...
        <div className="p-6 md:p-12 relative z-10">
            <div className="text-center mb-10">
                ...
                <p className="text-slate-400 text-sm max-w-md mx-auto">Choose the tier that fits your volume. Upgrade or cancel anytime.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 items-stretch">
                ...
                <div className={`p-6 rounded-2xl border flex flex-col relative shadow-lg transition-all ${subscription.tier === 'PLUS' ? 'border-blue-500 bg-slate-800/80 ring-1 ring-blue-500 shadow-blue-900/20' : 'border-blue-500/50 bg-slate-800/60 shadow-blue-900/10'}`}>
                    ...
                    <div className="mb-4">
                         ...
                         <div className="text-3xl font-bold text-white mb-1">$9.99 <span className="text-sm font-normal text-slate-500">/mo</span></div>
                ...
                <div className={`p-6 rounded-2xl border-2 flex flex-col relative overflow-hidden shadow-[0_0_30px_rgba(57,255,20,0.15)] transform md:-translate-y-2 transition-all ${subscription.tier === 'PRO' ? 'border-neon-green bg-slate-800 ring-2 ring-neon-green/30' : 'border-neon-green bg-slate-800'}`}>
                    ...
                    <div className="mb-4">
                         ...
                         <div className="text-3xl font-bold text-white mb-1">$29 <span className="text-sm font-normal text-slate-500">/mo</span></div>
